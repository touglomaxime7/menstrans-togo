...
export default function SplashScreen() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      // Si déjà connecté, aller au dashboard adapté
      if (isAuthenticated) {
    ...
    }, 2000); // 2 secondes pour bien voir le logo
    return () => clearTimeout(timer);
  }, [isAuthenticated, utilisateur, navigate]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0C2444] via-[#1F3864] to-[#2E5FA3] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {/* Effet décoratif : cercles flous en arrière-plan */}
